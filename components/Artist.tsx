...
const Artist = ({ artist }: Props) => {
  return (
    <div className="flex h-16 w-full flex-row transition-all ease-in-out justify-between duration-300 items-center gap-3 rounded-md px-3 text-sm text-white hover:bg-indigo-500 active:bg-indigo-600 hover:cursor-pointer">
