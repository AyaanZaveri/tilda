...
const Sidebar = () => {
  ...
  return (
    ...
    >
      <div className="bg-slate-100 dark:bg-slate-800 rounded-xl w-56 h-full flex flex-col justify-start items-start hover:shadow-sky-500/30 shadow-2xl shadow-sky-500/10 transition ease-in-out duration-1000">
